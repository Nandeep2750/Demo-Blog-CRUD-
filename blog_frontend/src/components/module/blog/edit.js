    ...
    getPostData = () => {
        ...
        api.post("/admin_api/blog/get_post_by_id", {
            ...
            if (res.status === 200) {
                ...
                this.setState({ fields }, () => {
                    console.log("🚀 ~ file: editStaticContent.js ~ line 50 ~ addStaticContent ~ this.setState ~ this.state", this.state)
                })
            } else if (res.status === 401) {
                toast.error(res.message);
                this.props.logout();
        ...
        return (
            <div className="container">
                ...
                <div className="mt-4 mb-3">
                    <h3 className="float-left"> Edit Blog Post </h3>
                    ...
                    <Card.Body>
                        <form onSubmit={this.handleSubmit}>
                            <div className="card-block">
                                ...
                                <input type="submit" className="btn btn-dark float-right mt-4" value="Save" />
                            </div>
                        </form>
                    </Card.Body>
                </Card>
